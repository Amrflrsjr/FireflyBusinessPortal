        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentOptions = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecordedByFK = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerId = table.Column<int>(type: "integer", nullable: false),
                    ContactId = table.Column<int>(type: "integer", nullable: false),
                    ContactNameSnapshot = table.Column<string>(type: "text", nullable: false),
                    ContactEmailSnapshot = table.Column<string>(type: "text", nullable: false),
                    ContactPositionSnapshot = table.Column<string>(type: "text", nullable: false),
                    ...
                    NoteToCustomer = table.Column<string>(type: "text", nullable: false),
                    PreparedByFK = table.Column<string>(type: "text", nullable: false),
